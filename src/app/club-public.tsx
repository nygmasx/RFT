...
function makeStyles(t: Theme) {
  return StyleSheet.create({
    container: { flex: 1, backgroundColor: t.ink }, center: { flex: 1, alignItems: 'center', justifyContent: 'center', backgroundColor: t.ink }, safe: { position: 'absolute', zIndex: 5, left: 16, top: 0 }, back: { width: 40, height: 40, borderRadius: 20, backgroundColor: t.surface + 'DD', alignItems: 'center', justifyContent: 'center' }, content: { paddingHorizontal: 20 },
    ...
    disciplines: { flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'center', gap: 6, marginTop: 14 }, discipline: { borderWidth: 1, borderColor: t.crimson, paddingHorizontal: 9, paddingVertical: 5 }, disciplineText: { color: t.crimson, fontFamily: FONTS.mono, fontSize: 8, letterSpacing: 1 }, notice: { padding: 12, color: '#6EB38C', borderWidth: 1, borderColor: '#4A8F6D55', backgroundColor: '#4A8F6D12', fontSize: 12 },
    section: { color: t.textMute, fontFamily: FONTS.mono, fontSize: 9, letterSpacing: 1.8, marginTop: 22, marginBottom: 8 }, infoCard: { backgroundColor: t.surface, borderWidth: 1, borderColor: t.hairline }, info: { minHeight: 55, paddingHorizontal: 14, flexDirection: 'row', alignItems: 'center', gap: 11, borderBottomWidth: 1, borderBottomColor: t.hairline }, infoText: { color: t.bone, fontSize: 12.5, flex: 1 },
    coaches: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 }, coach: { width: '48.8%', alignItems: 'center', padding: 15, backgroundColor: t.surface, borderWidth: 1, borderColor: t.hairline }, avatar: { width: 64, height: 64, borderRadius: 32, backgroundColor: t.elevated, overflow: 'hidden', alignItems: 'center', justifyContent: 'center' }, initials: { color: t.bone, fontWeight: '900' }, coachName: { color: t.bone, fontWeight: '800', fontSize: 12, marginTop: 9, textAlign: 'center' }, coachMeta: { color: t.textMute, fontFamily: FONTS.mono, fontSize: 7, marginTop: 3 }, flex: { flex: 1 },
    plan: { padding: 16, marginBottom: 8, backgroundColor: t.surface, borderWidth: 1, borderColor: t.hairline }, planName: { color: t.bone, fontFamily: FONTS.display, fontWeight: '900', fontSize: 17 }, planPrice: { color: t.crimson, fontFamily: FONTS.display, fontWeight: '900', fontSize: 27, marginTop: 7 }, planDescription: { color: t.textDim, fontSize: 12, lineHeight: 18, marginTop: 8 }, feature: { color: t.textDim, fontSize: 11, marginTop: 6 }, planLink: { marginTop: 13, paddingVertical: 10, borderTopWidth: 1, borderTopColor: t.hairline }, planLinkText: { color: t.crimson, fontFamily: FONTS.mono, fontWeight: '800', fontSize: 8 },
    session: { minHeight: 64, padding: 12, flexDirection: 'row', alignItems: 'center', gap: 10, backgroundColor: t.surface, borderWidth: 1, borderColor: t.hairline, marginBottom: 7 }, sessionActive: { borderColor: t.crimson }, sessionTitle: { color: t.bone, fontWeight: '800', fontSize: 13 }, sessionMeta: { color: t.textMute, fontFamily: FONTS.mono, fontSize: 7.5, marginTop: 5 }, tryText: { color: t.crimson, fontFamily: FONTS.mono, fontSize: 8, fontWeight: '800' }, empty: { color: t.textMute, backgroundColor: t.surface, borderWidth: 1, borderColor: t.hairline, padding: 18, textAlign: 'center', fontSize: 12 },
    primary: { minHeight: 52, backgroundColor: t.crimson, alignItems: 'center', justifyContent: 'center', marginTop: 16 }, primaryText: { color: '#FFF', fontFamily: FONTS.display, fontSize: 11, fontWeight: '900', letterSpacing: 1.4 }, form: { backgroundColor: t.surface, padding: 15, borderWidth: 1, borderColor: t.hairline }, formTitle: { color: t.bone, fontFamily: FONTS.display, fontSize: 19, fontWeight: '900' }, formDescription: { color: t.textDim, fontSize: 12, lineHeight: 18, marginTop: 6, marginBottom: 6 }, input: { minHeight: 50, color: t.bone, backgroundColor: t.ink, borderWidth: 1, borderColor: t.hairlineStrong, marginTop: 10, paddingHorizontal: 12 }, textarea: { minHeight: 100, paddingTop: 12, textAlignVertical: 'top' }, login: { alignItems: 'center', paddingVertical: 22 }, loginText: { color: t.textDim, fontFamily: FONTS.mono, fontSize: 8, letterSpacing: 1.2, textDecorationLine: 'underline' },
  });
}
